...
## Documentation
Full documentation can be found in [documentation.md](addons/calendar_library/documentation.md) and is supported in the editor through the Documentation Help section. Search for Calendar, Calendar.Date and CalendarLocale.
